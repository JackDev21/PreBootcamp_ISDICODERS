const fibonacciSeries = (fibonacciSequenceLength) => {
  // Declaramos funcion llamada fibonacciSeries, con un parámetro.
  ...
  for (let i = 0; i < fibonacciSequenceLength; i++) {
    // Bucle for que se ejecuta mientras i sea menor que fibonacciSequenceLength, se inicia en 0 y se incrementa en 1 en cada iteración.
